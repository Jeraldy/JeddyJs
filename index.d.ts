...
export declare const AreaInput: (props: any) => HTMLElement;
export declare const Article: (props: any) => HTMLElement;
export declare const Aside: (props: any) => HTMLElement;
export declare const Bold: (props: any) => HTMLElement;
export declare const Break: (props: any) => HTMLElement;
export declare const _Button: (props: any) => HTMLElement;
export declare const _CheckBox: (props: any) => HTMLElement;
export declare const Code: (props: any) => HTMLElement;
export declare const _DatePicker: (props: any) => HTMLElement;
export declare const Div: (props: any) => HTMLElement;
export declare const _DropDown: (props: any) => HTMLElement;
export declare const DropDownItem: (props: any) => HTMLElement;
export declare const _FileField: (props: any) => HTMLElement;
export declare const Footer: (props: any) => HTMLElement;
export declare const Form: (props: any) => HTMLElement;
export declare const H1: (props: any) => HTMLElement;
export declare const H2: (props: any) => HTMLElement;
export declare const H3: (props: any) => HTMLElement;
export declare const H4: (props: any) => HTMLElement;
export declare const H5: (props: any) => HTMLElement;
export declare const H6: (props: any) => HTMLElement;
export declare const Header: (props: any) => HTMLElement;
export declare const Hr: (props: any) => HTMLElement;
export declare const I: (props: any) => HTMLElement;
export declare const Iframe: (props: any) => HTMLElement;
export declare const Image: (props: any) => HTMLElement;
export declare const Label: (props: any) => HTMLElement;
export declare const Link: (props: any) => HTMLElement;
export declare const ListItem: (props: any) => HTMLElement;
export declare const Main: (props: any) => HTMLElement;
export declare const Nav: (props: any) => HTMLElement;
export declare const Node: (props: {}, tag: string) => HTMLElement;
export declare const OrderedList: (props: any) => HTMLElement;
export declare const Paragraph: (props: any) => HTMLElement;
export declare const Pre: (props: any) => HTMLElement;
export declare const _RadioButton: (props: any) => HTMLElement;
export declare const SVG: (props: any) => HTMLElement;
export declare const Script: (props: any) => HTMLElement;
export declare const Section: (props: any) => HTMLElement;
export declare const Small: (props: any) => HTMLElement;
export declare const Span: (props: any) => HTMLElement;
export declare const Strong: (props: any) => HTMLElement;
export declare const Style: (props: any) => HTMLElement;
export declare const Sub: (props: any) => HTMLElement;
export declare const Summary: (props: any) => HTMLElement;
export declare const Table: (props: any) => HTMLElement;
export declare const Tbody: (props: any) => HTMLElement;
export declare const Td: (props: any) => HTMLElement;
export declare const TextInput: (props: any) => HTMLElement;
export declare const TextView: (text: string) => Text;
export declare const Tfoot: (props: any) => HTMLElement;
export declare const Th: (props: any) => HTMLElement;
export declare const Thead: (props: any) => HTMLElement;
export declare const Tr: (props: any) => HTMLElement;
export declare const UnorderedList: (props: any) => HTMLElement;

export declare const Center: ({ child }: {
    child: any;
}) => HTMLElement;

export declare const RelativeLayout: ({ children }: {
    children: any[];
}) => HTMLElement;

export declare const Stepper: ({ child, activeStep, callBack, steps }: {
    child: any;
    activeStep: number;
...
export { ButtonType, ColAlignment, RowAlignment };

export declare const Button: ({ label, icon, type, onclick }: {
    label?: string;
    icon?: string;
    type?: ButtonType;
...
export declare const Column: ({ children, align }: {
    children: any[];
    align?: ColAlignment;
}) => HTMLElement;

export declare const Row: ({ children, align, id }: {
    children: any[];
    align?: RowAlignment;
    id?: any;
}) => HTMLElement;

export declare const Card: (props?: any) => HTMLElement;
export declare const CheckBox: (props?: any) => HTMLElement;
export declare const Container: (props: any) => HTMLElement;
export declare const DatePicker: (props?: any) => HTMLElement;
export declare const Dialog: ({ open, title }: {
    open?: boolean;
    title: string;
}) => HTMLElement;

export declare const Divider: (props?: any) => HTMLElement;
export declare const DropDown: (props?: any) => HTMLElement;
export declare const FileField: (props: any) => HTMLElement;
export declare const Icon: (props: any) => HTMLElement;
export declare const Loader: ({ radius, thickness, color }?: {
    radius?: string;
    thickness?: string;
    color?: string;
}) => HTMLElement;
export declare const RadioButton: (props?: any) => HTMLElement;
export declare const SearchField: () => HTMLElement;
export declare const DataTable: ({ data, titles, actions, title }: {
    data: any[][];
    titles: {
        title: string;
        style: any;
...
export declare const TextArea: (props?: any) => HTMLElement;
export declare const TextField: (props?: any) => HTMLElement;
