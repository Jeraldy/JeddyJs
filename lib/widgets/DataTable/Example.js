...
var TableExample = /** @class */ (function (_super) {
    ...
    TableExample.prototype.componentDidMount = function () {
        this.generateData();
    };
    TableExample.prototype.generateData = function () {
    ...
    TableExample.prototype.action = function (id) {
        return Div_1.default({
            class: 'mdc-menu-surface--anchor',
            children: [
                ActionButton_1.default({
                    icon: 'more_vert',
                    onclick: function () { return Menu_1.toggleMenu(id); },
                }),
                Menu_1.default({
                    id: id,
                    menuItems: [
