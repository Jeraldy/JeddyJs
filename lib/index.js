...
class StatefulWidget {
    ...
    setState(newState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tree_n = Reconcile_1.generateHTree(this.render());
            let tree_o = Reconcile_1.generateHTree(this.node);
            Reconcile_1.updateElement(document.getElementById(this.constructor.name), tree_n, tree_o);
