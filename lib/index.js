...
class StatefulWidget {
    ...
    setState(NewState, e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Reconcile_1.updateElement(this.node.parentNode, Reconcile_1.generateHTree(newNode), Reconcile_1.generateHTree(this.node));
            this.node = newNode;
...
exports.Jeddy = {
    Init(entryNode, rootNode) {
        Reconcile_1.updateElement(rootNode, Reconcile_1.generateHTree(entryNode));
    }
};
