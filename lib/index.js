...
exports.Jeddy = {
    Init({ app, reducers }) {
        ...
        const stateReady = () => {
            console.log("=============================");
            console.log(jredux_1.state);
            console.log("=============================");
            if (jredux_1.state.hasOwnProperty('reducer')) {
                return stateReady();
            }
            setTimeout(() => Reconcile_1.updateElement(document.getElementById("root"), Reconcile_1.generateHTree(app)), 100);
        };
    },
};
