...
class StatefulWidget {
    constructor(props) {
        ...
        this.props = props;
        if (props.reducers) {
            jredux_1.replaceReducer(redux_1.combineReducers(Object.assign({}, props.reducers)));
        }
    ...
    setState(newState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let _newNode = Reconcile_1.generateHTree(newNode);
            // let _node = generateHTree(this.node)
            console.log("_newNode::::::::::::::::::::::::");
            console.log(_newNode);
            console.log("_node::::::::::::::::::::::::");
            // console.log(_node)
            Reconcile_1.updateElement(document.getElementById("root"), _newNode, this._node);
            this._node = _newNode;
    ...
    connect() {
        ...
        this._node = Reconcile_1.generateHTree(this.node);
        return this.node;
    }
}
